        ...
        RecipeFamily
    {
        public NewButcherDomesticatedTurkeyRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    "ButcherTurkey",
                    Localizer.DoStr("Butcher Farm Raised Turkey"),
                    new IngredientElement[]
                    {
               new IngredientElement(typeof(DomesticatedTurkeyItem), 1, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)),
                    },
                    new CraftingElement[]
                    {
               new CraftingElement<RawMeatItem>(2),
               new CraftingElement<LeatherHideItem>(1),
               //new CraftingElement<BonesItem>(1),
               new CraftingElement<FeatherItem>(2),
                    })
            };
